...
export const checkoutService = {
  ...
  async settleSuccessTx(client: PoolClient, order: OrderView & { userId: string }): Promise<OrderView & { userId: string }> {
...
async function lockOrder(client: PoolClient, orderId: string): Promise<OrderView & { userId: string }> {
...
async function getOrderInView(client: PoolClient, orderId: string): Promise<OrderView & { userId: string }> {
  const res = await client.query(
...
async function getOrderItems(client: PoolClient | undefined, orderId: string): Promise<OrderItemView[]> {
